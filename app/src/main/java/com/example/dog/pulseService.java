...
public class pulseService extends Service{
    ...
    public static double Service_purse;
    public static double Purse_purse;
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        Purse_purse = Objects.requireNonNull(intent.getExtras()).getDouble(String.valueOf(pulseService.Service_purse));

        boolean pulsealarm = Objects.requireNonNull(intent.getExtras()).getBoolean(pulseService.MESSAGE_KEY);

        if(pulsealarm){
            Intent mMainIntent = new Intent(this, purse.class);
            PendingIntent mPendingIntent = PendingIntent.getActivity(
                    this, 2, mMainIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            //CoolCount++;
    ...
    public void pulseNotification() {
        ...
        builder.setContentText("현재 맥박 : " + Purse_purse );//알림창 내용
